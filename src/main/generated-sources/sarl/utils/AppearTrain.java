...
public class AppearTrain extends Agent {
  ...
  private void $behaviorUnit$Initialize$0(final Initialize occurrence) {
    abstract class __AppearTrain_0 extends TimerTask {
    ...
    _$CAPACITY_USE$IO_SARL_CORE_LOGGING$CALLER_1.info("Appear Train : The agent was started.");
    ...
    this.timer = _timer;
    __AppearTrain_0 ___AppearTrain_0 = new __AppearTrain_0() {
      @Override
      public void run() {
        int _nextInt = AppearTrain.this.rand.nextInt(100);
        if ((_nextInt > 95)) {
    ...
    this.timer.schedule(___AppearTrain_0, 0, 5000);
  }
  
  private void $behaviorUnit$Destroy$1(final Destroy occurrence) {
    Logging _$CAPACITY_USE$IO_SARL_CORE_LOGGING$CALLER = this.$castSkill(Logging.class, (this.$CAPACITY_USE$IO_SARL_CORE_LOGGING == null || this.$CAPACITY_USE$IO_SARL_CORE_LOGGING.get() == null) ? (this.$CAPACITY_USE$IO_SARL_CORE_LOGGING = this.$getSkill(Logging.class)) : this.$CAPACITY_USE$IO_SARL_CORE_LOGGING);
    _$CAPACITY_USE$IO_SARL_CORE_LOGGING$CALLER.info("Appear Train : The agent was stopped.");
  }
  ...
  public boolean equals(final Object obj) {
    ...
    if (getClass() != obj.getClass())
      return false;
    AppearTrain other = (AppearTrain) obj;
  ...
  @SyntheticMember
  public AppearTrain(final UUID parentID, final UUID agentID) {
  ...
  @Inject
  @Deprecated
  public AppearTrain(final BuiltinCapacitiesProvider provider, final UUID parentID, final UUID agentID) {
    super(provider, parentID, agentID);
  }
  
  @SyntheticMember
  @Inject
  public AppearTrain(final UUID parentID, final UUID agentID, final DynamicSkillProvider skillProvider) {
